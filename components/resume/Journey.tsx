...
const Journey = ({ className = "" }: JourneyProps) => {
  const data = [
    /** Start */
    {
      ...
      content: (
        <div>
          <h2 className="text-secondary text-2xl sm:text-3xl font-semibold mb-6">
    ...
    /** Blue Duck */
    {
      ...
      content: (
        <div>
          ...
          <p className="text-base sm:text-lg mb-4">Key projects:</p>
          <ul className="list-inside text-base sm:text-lg mb-5 space-y-5">
            <li>
              <h3 className="font-[500] text-xl sm:text-2xl mb-2">
        ...
        <div>
          ...
          <ul className="list-inside text-base sm:text-lg mb-5 space-y-5">
            ...
            <li>
              ...
              <ul className="font-[400] list-inside ml-6 list-disc text-base">
                <li>
                  Developed user-friendly interfaces with robust functionality.
                </li>
                <li>
                  Implemented server components for seamless backend
                  integration.
                </li>
                <li>
                  Designed a complex state management system using Zustand
                  library.
                </li>
                <li>
                  Created a custom video player with advanced matching
                  algorithms.
                </li>
                <li>
                  Integrated authentication using Clerk for secure user access.
                </li>
                <li>
                  Consistently received positive feedback for problem-solving
